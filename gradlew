...
if [ -z "${JEMMA:-}" ]; then
    ...
    if [ "${FOUNDRY_CONTAINER_RUNTIME_TYPE:-}" = "CODE_WORKSPACE" ]; then
        ...
        export ORG_GRADLE_PROJECT_objectSetServiceApiUri=$(uri object_set_service)
        ...
        export ORG_GRADLE_PROJECT_objectSetServiceApiUri=$ORG_GRADLE_PROJECT_externalUri/object-set-service/api
